""" Simple Single Counterfactual Test
This script has a simple implementation to add your counterfactual generation algorithm to be benchmarked with
several datasets.

All alterations that must be done are indicated in the comments "!!CHANGE BELOW!!:"
"""
import time
...
# THIS IS THE MAIN FUNCTION YOU HAVE TO MODIFY, IT PROVIDES SEVERAL PARAMETERS FROM DATA TO USE IN THE CF GENERATION
